...
OUTPUT_DIR = ensure_dir(VISUALIZATIONS_DIR / "visualize_brain_3d")
...
def generate_brain_color_video(
    ...
    temp_frames_dir = OUTPUT_DIR / "temp_color_frames"
    ...
    if not video_created:
        ...
        final_frames_dir = OUTPUT_DIR / f"color_frames_{subject}_{cond}_{band}"
